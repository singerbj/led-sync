    ...
    <>
      <div>
        <Background hsvMod={hsvMod}>
          ...
          >
            Auto Detect Color Based on Video Capture
          </button>
          <br />
          <br />
          <br />
          ...
          >
            Saturation Modifier: {(hsvMod.s > 0 ? "+" : "") + hsvMod.s}
          </div>
          <br />
          <br />
          <button
          ...
          >
            Value Modifier: {(hsvMod.v > 0 ? "+" : "") + hsvMod.v}
          </div>
          <br />
          <br />
          <button
